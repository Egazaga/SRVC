...
do
    ...
    #echo ffprobe -v error -select_streams v -of default=noprint_wrappers=1:nokey=1 -show_entries stream=r_frame_rate ${mp4_name}
    ...
    do
        input_video=${file}
        echo ${input_video}
        output_prefix="${resize_dir}/${name}_h${format}_${width}x${height}"
